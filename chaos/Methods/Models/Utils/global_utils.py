...
def getHQRCParser(parser):
	...
	parser.add_argument("--norm_every", help="normalize the states every number of time steps", type=int, default=0)
	parser.add_argument("--augment", help="augment data", type=int, default=0)
