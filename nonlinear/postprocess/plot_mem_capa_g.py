...
if __name__  == '__main__':
    ...
    parser.add_argument('--prefix', type=str, default='qrc_stm_ridge_pinv_2020-06-23')
    ...
    for j in range(M):
        ...
        if len(rsarr) > 0:
            ...
            xs, avg_tests, std_tests = rsarr[:, 3], rsarr[:, -2], rsarr[:, -1]
    ...
    for ftype in ['png']:
        plt.savefig('{}_capa_non_diag.{}'.format(outbase, ftype), bbox_inches='tight')
    plt.show()
